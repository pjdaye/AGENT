from Abstraction.ActionableState import ActionableState
...
class StateAbstracter:
    ...
    def process(self, context, concrete_state):
    ...
    def build_selector(widget, selectors):
        tag = widget["properties"]["tagName"]
        id = widget["properties"]["id"] if "id" in widget["properties"] else None
